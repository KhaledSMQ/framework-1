...
namespace Framework.Data.Config
{
    public class Lib : Core.Config.ModuleConfiguration
    {
        ...
        public static readonly string DEFAULT_ERROR_MSG_PREFIX = Framework.Base.GetDefaultErrorPrefix(System.Reflection.Assembly.GetExecutingAssembly());

        // 
        // Default Xml namespace.
        //

        public static readonly string DEFAULT_XML_NAMESPACE = Framework.Base.GetDefaultXmlNamespace(System.Reflection.Assembly.GetExecutingAssembly());

        //
        // Default config section name for library.
        //

        public static readonly string DEFAULT_CONFIG_SECTION_NAME = Framework.Base.GetConfigSectionName(System.Reflection.Assembly.GetExecutingAssembly());
