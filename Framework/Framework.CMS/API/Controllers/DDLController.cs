...
namespace Framework.CMS.Api.Controllers
{
    public class CmsDDLController : AControllerServiceWrapper<IDML>
    {
        ...
        {
            return Ok(Srv.Create<Cluster>(item, Scope.Hub.GetUnique<ICluster>()));
        }
        ...
        {
            return Ok(Srv.Get<Cluster>(from => from.Visible().ByID(id), Scope.Hub.GetUnique<ICluster>()));
        }
        ...
        {
            return Ok(Srv.Get<Cluster>(from => from.Visible().ByRef(id), Scope.Hub.GetUnique<ICluster>()));
        }
        ...
        {
            return Ok(Srv.GetList<Cluster>(from => from.Visible(), Scope.Hub.GetUnique<ICluster>()));
        }
        ...
        {
            return Ok(Srv.GetList<Entity>(from => from.Visible().Include(item => item.Owner).Where(item => item.Owner.Ref == id), Scope.Hub.GetUnique<IEntity>()));
        }
        ...
        {
            return Ok(Srv.Create<Entity>(item, Scope.Hub.GetUnique<IEntity>()));
        }
        ...
        public IHttpActionResult Entity_Get(int id)
        {
            return Ok(Srv.Get<Entity>(from =>
                from.ByID(id)
                    ...
                    .Include(e => e.Views)
                    .Include(e => e.Schemas)
                    .Include(e => e.Forms), Scope.Hub.GetUnique<IEntity>()));
        }
        ...
        {
            return Ok(Srv.GetList<Entity>(from => from.Visible(), Scope.Hub.GetUnique<IEntity>()));
        }
        ...
        {
            return Ok(Srv.Create<View>(item, Scope.Hub.GetUnique<IView>()));
        }
        ...
        {
            return Ok(Srv.Get<View>(from => from.Visible().ByID(id), Scope.Hub.GetUnique<IView>()));
        }
        ...
        {
            return Ok(Srv.Get<View>(from => from.Visible().ByRef(id), Scope.Hub.GetUnique<IView>()));
        }
        ...
        {
            return Ok(Srv.GetList<View>(from => from.Visible(), Scope.Hub.GetUnique<IView>()));
        }
        ...
        public IHttpActionResult View_ListByEntity(string id)
        {
            return Ok(Srv.GetList<Entity>(from =>
                ...
                .Where(item => item.Owner.Ref == id), Scope.Hub.GetUnique<IEntity>()));
        }
        ...
        {
            return Ok(Srv.Create<ContentType>(item, Scope.Hub.GetUnique<IContentType>()));
        }
        ...
        {
            return Ok(Srv.Get<ContentType>(from => from.Visible().ByID(id), Scope.Hub.GetUnique<IContentType>()));
        }
        ...
        {
            return Ok(Srv.GetList<ContentType>(from => from.Visible(), Scope.Hub.GetUnique<IContentType>()));
        }
        ...
        {
            return Ok(Srv.GetList<ContentType>(from => from.Visible().Include(item => item.Owner).Where(item => item.Owner.Ref == id), Scope.Hub.GetUnique<IContentType>()));
        }
    }
}