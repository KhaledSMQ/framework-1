...
namespace Framework.Drawing.SVG.DOM.Text
{
    ...
    public class SvgText : SvgVisualElement
    {
        ...
        private SvgTextAnchor _textAnchor = SvgTextAnchor.none;
        ...
        {
            get { return (this._font.Name.ToString() == "Times New Roman") ? null : this._font; }
        ...
        {
            get { return (this.Attributes["Fill"] == new SvgColourServer(Color.Black)) ? null : (SvgPaintServer)this.Attributes["Fill"]; }
