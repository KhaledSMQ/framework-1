...
using Framework.Drawing.SVG.DOM.Exceptions;
...
namespace Framework.Drawing.SVG.DOM.DataTypes
{
    ...
    public struct SvgViewBox
    {
        ...
        /// <summary>
        /// Performs an implicit conversion from <see cref="Framework.Drawing.SVG.DOM.Basic_Shapes.SvgViewBox"/> to <see cref="System.Drawing.RectangleF"/>.
        /// </summary>
    ...
    internal class SvgViewBoxConverter : TypeConverter
    {
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            if (destinationType == typeof(string))
            {
                SvgViewBox val = (SvgViewBox)value;
                return val.MinX + " " + val.MinY + " " + val.Width + " " + val.Height;
            }
