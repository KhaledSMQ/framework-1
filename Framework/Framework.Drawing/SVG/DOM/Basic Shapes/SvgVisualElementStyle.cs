...
namespace Framework.Drawing.SVG.DOM.Basic_Shapes
{
    public abstract partial class SvgVisualElement
    {
        ...
        {
            get { return (this.Attributes["Fill"] == null || this.Attributes["Fill"].ToString().Equals("Transparent")) ? null : (SvgPaintServer)this.Attributes["Fill"]; }
        ...
        {
            get { return (this.Attributes["FillRule"] == null) ? SvgFillRule.none : (SvgFillRule)this.Attributes["FillRule"]; }
        ...
        {
            get { return (this.Attributes["Fill"] != null && this.Attributes["Fill"].ToString().Equals("Transparent")) ? 0f : (this.Attributes["FillOpacity"] == null) ? float.NaN : (float)this.Attributes["FillOpacity"]; }
        ...
        {
            get { return (this.Attributes["StrokeWidth"] == null) ? new SvgUnit(float.NaN) : (SvgUnit)this.Attributes["StrokeWidth"]; }
        ...
        {
            get { return (this.Attributes["StrokeLineCap"] == null) ? SvgStrokeLineCap.none : (SvgStrokeLineCap)this.Attributes["StrokeLineCap"]; }
        ...
        {
            get { return (this.Attributes["StrokeLineJoin"] == null) ? SvgStrokeLineJoin.none : (SvgStrokeLineJoin)this.Attributes["StrokeLineJoin"]; }
        ...
        {
            get { return (this.Attributes["StrokeMiterLimit"] == null) ? float.NaN : (float)this.Attributes["StrokeMiterLimit"]; }
        ...
        {
            get { return (this.Attributes["StrokeOpacity"] == null) ? float.NaN : (float)this.Attributes["StrokeOpacity"]; }
        ...
        {
            get { return (this.Attributes["Opacity"] == null) ? float.NaN : (float)this.Attributes["Opacity"]; }
